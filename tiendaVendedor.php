    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link" aria-current="page" href="tiendaCliente.html">Tienda</a>
          </li>
          <li class="nav-item ">
            <a class="nav-link" id="logoutButton" type="button" aria-current="page" href="tiendaLogin.html">Cerrar sesión</a>
          </li> 
        </ul>
      </div>
    </div>
            ...
            <div class="row g-0">
              <div class="col-md-12 d-flex align-items-center">
                <div class="card-body p-4 p-lg-5 text-black">
                  <form action="./backend/files/registroProductos.php" method="post">
                    <div class="d-flex align-items-center mb-3 pb-1">
                      
                      <span class="h1 fw-bold mb-0">Registro de productos</span>
                    </div>
            ...
            <table class="table table-hover table-light">
              <thead>
                <tr>
                  ...
                  <th scope="col">Facebook del vendedor</th>
                  <th scope="col">Teléfono del vendedor</th>
